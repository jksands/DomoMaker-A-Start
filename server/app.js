...
let redisURL = {
  ...
  hostname: 'redis-15104.c258.us-east-1-4.ec2.cloud.redislabs.com',
  port: 15104,
};

let redisPASS = 'l8ruBExWWGQOeakiRsq4qI4PWOajKqXd';
...
// csrf comse afterp cookieParser and app,use session but before router
app.use(csrf());
